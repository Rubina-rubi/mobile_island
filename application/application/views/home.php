	...
	<section class="section-slide">
		<div class="wrap-slick1">
			...
			<?php foreach($news as $show) {   ?>
				<div class="item-slick1" style="background-image: url(<?=base_url()?>img/<?=$show['file_path']?>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?=base_url()?>product" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="<?=base_url()?>product" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										<div class="">
											...
											<input class="" type="text"  id="add-cart-<?=$row['p_id']?>" name="num-product" value="1">
...
<script type="text/javascript"> 
		...
		$('.js-modal<?=$row['p_id']?>').removeClass('show-modal<?=$row['p_id']?>');
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="<?=base_url()?>Welcome/index/<?=$current+4?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
