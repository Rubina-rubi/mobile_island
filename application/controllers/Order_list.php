...
class Order_list extends CI_Controller {
	...
	public function index()
	{
		...
		foreach ($o_data['order_data_list2'] as $cart_total) {
			
			$o_data['total_cart'] = $o_data['total_cart']+$cart_total['amount'];
		}
