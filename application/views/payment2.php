		...
		<div class="container">
			<div class="flex-w flex-tr">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					<input type="password" name="password" value="<?=set_value('password')?>"  class="form-control input-lg" placeholder="CVC" name="cvc" size="4" autocomplete="off" class="card-cvc" />
					</div>
					<div class="form-group">
